...
//  Manager()->AddHisto("AFB_neg_Rap_06",  15,50.,200., "Rap_06");
  ...
  Manager()->AddHisto("AFB_pos_Rap_No",  13,4900.,6100., "Rap_No");
  Manager()->AddHisto("AFB_neg_Rap_No",  13,4900.,6100., "Rap_No");  

  Manager()->AddHisto("AFB_pos_Rap_00",  13,4900.,6100., "Rap_00");
  Manager()->AddHisto("AFB_neg_Rap_00",  13,4900.,6100., "Rap_00");

  Manager()->AddHisto("AFB_pos_Rap_01",  13,4900.,6100., "Rap_01");
  Manager()->AddHisto("AFB_neg_Rap_01",  13,4900.,6100., "Rap_01");  

  Manager()->AddHisto("AFB_pos_Rap_02",  13,4900.,6100., "Rap_02");
  Manager()->AddHisto("AFB_neg_Rap_02",  13,4900.,6100., "Rap_02");

  Manager()->AddHisto("AFB_pos_Rap_04",  6,4900.,6100., "Rap_04");
  Manager()->AddHisto("AFB_neg_Rap_04",  6,4900.,6100., "Rap_04");

  Manager()->AddHisto("AFB_pos_Rap_06",  6,4900.,6100., "Rap_06");
  Manager()->AddHisto("AFB_neg_Rap_06",  6,4900.,6100., "Rap_06");
